...
L.NonTiledLayer.WCS = L.NonTiledLayer.extend({
  ...
  initialize: function(url, options) {
    ...
    this.options.colorScale =
      options.colorScale == undefined ? 'viridis' : options.colorScale;
    this.options.clampLow =
      options.clampLow == undefined ? true : options.clampLow;
    this.options.clampHigh =
      options.clampHigh == undefined ? true : options.clampHigh;
